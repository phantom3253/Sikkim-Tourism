  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Monastery360 spiritual colors
        sacred: {
          red: "hsl(var(--sacred-red))",
          "red-light": "hsl(var(--sacred-red-light))",
          gold: "hsl(var(--sacred-gold))",
          "gold-light": "hsl(var(--sacred-gold-light))",
        },
        monastery: {
          brown: "hsl(var(--monastery-brown))",
          "brown-light": "hsl(var(--monastery-brown-light))",
        },
        spiritual: {
          white: "hsl(var(--spiritual-white))",
        },
        prayer: {
          blue: "hsl(var(--prayer-blue))",
          "blue-light": "hsl(var(--prayer-blue-light))",
        },
        sidebar: {
      ...
      animation: {
        ...
        "prayer-wheel": "prayer-wheel 8s linear infinite",
